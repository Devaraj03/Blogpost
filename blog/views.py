...
def navbar(request):
    if request.method == "POST":
         ...
         venues=Blogpost.objects.filter(title__contains=searched)
         return render(request,'others/navbar.html',{'searched':searched,'venues':venues})
    else:
         return render(request,'others/navbar.html',{})
